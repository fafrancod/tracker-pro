...
export interface TranslationDict {
  ...
  fin_installment_purchase: string;
  ...
  task_entails_money: string;
  task_entails_money_hint: string;
  task_entails_money_need_vault: string;
  task_money_pill: string;
  task_money_pill_locked: string;
...
const es_dict: TranslationDict = {
  ...
  fin_installment_purchase: 'Compra · {total} cuotas',
  ...
  fin_sql_needed:
    'Supabase tiene una migración de Finanzas pendiente. Ejecuta el bloque de reparación de finance_rules, finance_movements y finance_vault, y recarga.',
  fin_repeat: 'Repetir',
  ...
  pwa_install_title: 'Instalar Meteora',
  ...
  task_entails_money: 'Conlleva dinero',
  ...
  task_notes_placeholder: 'Contexto, detalles, links…',
...
const en_dict: TranslationDict = {
  ...
  fin_installment_purchase: 'Purchase · {total} installments',
  ...
  fin_view_week: 'Week',
  fin_sql_needed:
    'Supabase has a pending Finance migration. Run the finance_rules, finance_movements and finance_vault repair block, then reload.',
  fin_repeat: 'Repeat',
  ...
  pwa_install_title: 'Install Meteora',
  ...
  task_entails_money: 'Involves money',
  task_entails_money_hint:
  ...
  task_notes_placeholder: 'Context, details, links…',
